...
public class PidSortOrderOverrideTest {
	
	@ParameterizedTest
	@CsvSource(value = { 
			"true=STPX H:18DA10F1, D:22 1942 2805 1937 18F0 1935 1302 18BA 1004 1003 2001",
			"false=STPX H:18DA10F1, D:22 1942 2805 1937 2001 18F0 1935 1302 18BA 1004 1003"
			}, delimiter = '=')

	public void pidOrderOverrideTest(boolean lastInQuery, String queryRequest) throws IOException, InterruptedException {
		...
		CollectionUtils.addAll(pids,
				new Long[] { 7076l, 7021l, 7035l, 7002l, 7037l, 7047l, 7025l, 7003l, 7014l, 7036l, 7028l, 7016l, 17078l, 7005l, 7020l, 7019l, 7009l });

		final Query query = Query.builder().pids(pids).build();
		
		MockAdapterConnection connection = MockAdapterConnection.builder()
				.requestResponse(queryRequest,
		...
		final Adjustments optional = Adjustments.builder().debugEnabled(true)
				.debugEnabled(true)
				.override(7076l, PidDefinitionCustomization.builder().lastInTheQuery(lastInQuery).build())
