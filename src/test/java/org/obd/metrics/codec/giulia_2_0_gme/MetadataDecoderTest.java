...
public class MetadataDecoderTest {
	...
	public void vin_1_Test() {
		PidDefinitionRegistry pidDefinitionRegistry = PIDsRegistryCache.get("mode01.json");
	...
	public void vin_2_Test() {
		...
		PidDefinitionRegistry pidDefinitionRegistry = PIDsRegistryCache.get("giulia_2.0_gme.json");
