...
public class IdGeneratorPerformanceTest {
	...
	private final Object[][] frameMapping = { { "1000", 17, 2 }, { "1924", 27, 2 }, { "186B", 35, 2 }, { "1827", 45, 2 },
			{ "1828", 53, 2 }, { "1937", 63, 2 }, { "181F", 73, 2 }, { "180E", 81, 2 }, { "1867", 91, 2 },
			{ "186C", 99, 2 }, { "186D", 109, 2 }, { "186E", 117, 2 }, { "186F", 125, 2 }, { "1002", 137, 2 },
			{ "18AD", 145, 2 }, { "18AE", 155, 2 }, { "18C7", 163, 2 }, { "18AF", 173, 2 }, { "18C8", 181, 2 },
			{ "1910", 189, 2 }, { "1911", 199, 2 } };
	...
	public static void main(String[] args) throws RunnerException {
		final Options opt = new OptionsBuilder()
				.include(IdGeneratorPerformanceTest.class.getSimpleName())
	...
	public void setup() {
		...
		for (final String payload : payloads) {
			...
			for (final Object[] spec : frameMapping) {
				final String pid = (String) spec[0];
