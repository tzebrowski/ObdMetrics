...
public class VinCommandTest {
	...
	public void hexCommandTest(String raw,String expected) {
		...
		final HexCodec metadataDecoder = new HexCodec();
		final String decode = metadataDecoder.decode(pidDefinitionRegistry.findBy(11000l),
				ConnectorResponseFactory.wrap(raw.getBytes()));
		Assertions.assertThat(expected).isEqualTo(decode);
	}
}
