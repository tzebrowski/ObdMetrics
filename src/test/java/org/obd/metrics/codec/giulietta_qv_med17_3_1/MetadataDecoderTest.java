...
public class MetadataDecoderTest {
	...
	public void ecuIsoCodeTest() {
		...
		String decode = metadataDecoder.decode(pidDefinitionRegistry.findBy(16002l),
	...
	public void ecuSofwareNumberTest() {
		...
		String decode = metadataDecoder.decode(pidDefinitionRegistry.findBy(16003l),
				ConnectorResponseFactory.wrap(answer.getBytes()));
	...
	public void ecuTypeTest() {
		...
		String decode = metadataDecoder.decode(pidDefinitionRegistry.findBy(16005l),
				ConnectorResponseFactory.wrap(answer.getBytes()));
	...
	public void sparePartNumberTest() {
		...
		String decode = metadataDecoder.decode(pidDefinitionRegistry.findBy(16006l),
				ConnectorResponseFactory.wrap(answer.getBytes()));
	...
	public void homologationNumberTest() {
		...
		String decode = metadataDecoder.decode(pidDefinitionRegistry.findBy(16007l),
				ConnectorResponseFactory.wrap(answer.getBytes()));
	...
	public void softwareVersion() {
		...
		String decode = metadataDecoder.decode(pidDefinitionRegistry.findBy(16008l),
				ConnectorResponseFactory.wrap(answer.getBytes()));
	...
	public void hardwareVersion() {
		...
		String decode = metadataDecoder.decode(pidDefinitionRegistry.findBy(16009l),
				ConnectorResponseFactory.wrap(answer.getBytes()));
